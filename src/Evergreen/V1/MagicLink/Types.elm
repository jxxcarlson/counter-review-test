module Evergreen.V1.MagicLink.Types exposing (..)
...
type alias EnterLoginCode_ =
    { sentTo : Evergreen.V1.EmailAddress.EmailAddress
    , loginCode : String
...
type alias Model =
    ...
    , currentUserData : Maybe Evergreen.V1.User.SignInData
...
type LogItem
    = LoginsRateLimited Evergreen.V1.User.Id
...
type Msg
    ...
    | AuthSigninRequested
        { methodId : Evergreen.V1.Auth.Common.MethodId
        , email : Maybe String
        }
    ...
    | InputEmail String
    | SetRoute Evergreen.V1.Route.Route
